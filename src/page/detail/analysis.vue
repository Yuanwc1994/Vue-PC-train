  ...
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right" v-if="versionList.length > 0">
          <VSelection :selections="versionList"></VSelection>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">有效时间：</div>
        <div class="sales-board-line-right">
          <v-chooser :selections="effectiveTime"></v-chooser>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">产品版本：</div>
        <div class="sales-board-line-right">
          <VMulChoice :selections="multipleList"></VMulChoice>
        </div>
      </div>
      <div class="sales-board-line">
...
<script>
  import VSelection from 'components/other/selection';
  import VChooser from 'components/other/chooser';
  import VMulChoice from 'components/other/multipleChoice';
  export default {
    name: 'analysis',
    data() {
      return {
    ...
    methods: {
      getProduct() {
        this.$ajax.get('/prodData/api').then((response) => {
          let res = response.data.productData.selections;
          this.versionList = res.versionList;
          this.effectiveTime = res.effectiveTime;
    ...
    components: {
      VSelection, VChooser, VMulChoice
    }
  };
</script>
